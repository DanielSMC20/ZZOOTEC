        ...
        <div class="zt-messages" #messagesContainer>
          ...
          <div *ngIf="messages.length === 0" class="zt-empty">
            <span class="zt-empty__icon">
              ...
              >
                <path
                  d="M12 3c-4.97 0-9 3.185-9 7.115 0 2.557 1.522 4.82 3.889 6.205L6 20l4.447-2.724A10.6 10.6 0 0 0 12 17.23c4.97 0 9-3.185 9-7.115S16.97 3 12 3z"
                />
          ...
          <div *ngIf="isTyping" class="zt-row zt-row--bot">
            ...
            <div class="zt-typing"><span></span><span></span><span></span></div>
          </div>
        </div>
  ...
  styles: [
    ...
    ================================================================ */
      ...
      .zt-fab {
        ...
        user-select: none;
        box-shadow:
          0 8px 28px -4px rgba(29, 78, 216, 0.55),
      ...
      .zt-fab:hover {
        ...
        box-shadow:
          0 14px 32px -4px rgba(29, 78, 216, 0.65),
      ...
      .zt-messages::-webkit-scrollbar {
        width: 4px;
      }
      .zt-messages::-webkit-scrollbar-track {
        background: transparent;
      }
      .zt-messages::-webkit-scrollbar-thumb {
        background: #cbd5e1;
        border-radius: 99px;
      }
      ...
      .zt-bubble--user .zt-bubble__time {
        text-align: right;
        color: rgba(255, 255, 255, 0.8);
      }
      .zt-bubble--bot .zt-bubble__time {
        text-align: left;
        color: #94a3b8;
      }
      ...
      .zt-typing span:nth-child(2) {
        animation-delay: 0.14s;
      }
      .zt-typing span:nth-child(3) {
      ...
      .zt-send:hover:not(:disabled) {
        transform: scale(1.07);
        box-shadow: 0 4px 14px -2px rgba(29, 78, 216, 0.55);
      }
      .zt-send:active:not(:disabled) {
...
export class ChatbotComponent implements OnInit, AfterViewChecked {
  ...
  onDragMove(event: MouseEvent) {
    ...
    this.buttonBottom = Math.max(
      20,
      Math.min(newBottom, window.innerHeight - 100),
    );
  }
